...
const accordionData = [
  ...
  },
  {
    ...
    pages: [
      {
        id: "page-1-cli-commands001",
        image: "./assets/images/command-line.png",
        text: "Networking: Command Line Interface (CLI) Commands",
        modalTitle: `<i class="fa-solid fa-terminal"></i> CLI Commands For Networking`,
        modalText: "",
        description: "Master the essential CLI commands needed to configure, troubleshoot, and secure network devices. Explore how to manage switches, routers, DHCP servers, firewalls, and wireless networks using terminal-based tools. Learn how to utilize commands to set up IPv6 networks, ensure secure connections, and maintain seamless infrastructure for modern networking environments.",
        // This is the ID in the HTML of the hidden div:
        nestedAccordionId: "nestedAccordion-page-1-cli-commands001"
      },
      {
        id: "page-2-Wincli-commands002",
        image: "./assets/images/database.png",
        text: "File and Directory Management Commands",
        modalTitle: `<i class="fa-solid fa-folder-open me-2"></i> File and Directory Management Commands`,
        video: "",
        modalText: "",
        description: "Managing files and directories is a foundational skill in operating systems. The commands in this category enable you to navigate, organize, manipulate, and maintain your file system efficiently. From creating directories to advanced bulk copying, mastering these commands equips you with the tools to handle complex file operations confidently.",
        nestedAccordionId: "nestedAccordion-page-2-Wincli-commands002"
      },
      {
        id: "page-3-networkManagement",
        image: "./assets/images/networkManagement.png",
        text: "Network Management",
        modalTitle: `<i class="fa-solid fa-terminal"></i> Connectivity Commands`,
        video: "",
        modalText: "",
        description: "Network Management commands are essential tools for diagnosing, configuring, and troubleshooting network connections. These commands allow IT professionals to inspect connectivity, manage network interfaces, and ensure smooth communication between devices on a network.",
        nestedAccordionId: "nestedAccordion-page-3-networkManagement"
      },
      {
        id: "page-4-disk-danagement",
        image: "./assets/images/disk-storage.png",
        text: "Disk and Volume Management",
        modalTitle: `<i class="fa-solid fa-hard-drive"></i> Disk and Volume Management`,
        video: "",
        modalText: "",
        description: "Disk and Volume Management involves configuring, maintaining, and optimizing storage devices. This includes partitioning disks, formatting volumes, assigning drive letters, and managing storage space. Mastery of these commands ensures efficient utilization of storage and prevents data loss.",
        nestedAccordionId: "nestedAccordion-page-4-disk-danagement"
      },
      {
        id: "page-5-sys-info",
        image: "./assets/images/system-info.png",
        text: "System Information",
        modalTitle: `<i class="fa-solid fa-info-circle"></i> System Information Commands`,
        video: "",
        modalText: "",
        description: "System Information Commands provide critical insights into the hardware, software, and overall configuration of a computer. These commands are essential for diagnosing issues, optimizing performance, and auditing system setups.",
        nestedAccordionId: "nestedAccordion-page-5-sys-info"
      },
      {
        id: "page-6-sys-maintenance",
        image: "./assets/images/systemMaintenance.png",
        text: "System Maintenance and Troubleshooting",
        modalTitle: `<i class="fa-solid fa-screwdriver-wrench"></i> System Maintenance and Troubleshooting`,
        video: "",
        modalText: "",
        description: "System Maintenance and Troubleshooting commands are essential tools for ensuring the smooth operation of a computer system. These commands help identify, diagnose, and resolve common issues related to hardware, software, and performance.",
        nestedAccordionId: "nestedAccordion-page-6-sys-maintenance"
      },
      {
        id: "page-7-user-management",
        image: "./assets/images/account-management02.png",
        text: "User and Group Management",
        modalTitle: `<i class="fa-solid fa-users-cog"></i> User and Group Management`,
        video: "",
        modalText: "",
        description: "User and Group Management commands are critical for controlling access, permissions, and overall security in a system. They enable administrators to create, modify, and manage user accounts and groups efficiently.",
        nestedAccordionId: "nestedAccordion-page-7-user-management"
      },
      {
        id: "page-8-win-run-commands",
        image: "./assets/images/technical-support.png",
        text: "Windows Run Commands",
        modalTitle: `<i class="fa-solid fa-play-circle"></i> Windows Run Commands`,
        video: "",
        modalText: "",
        description: `Windows Run commands are shortcuts to access various system tools, utilities, and settings quickly. By typing these commands in the Run dialog box (<kbd>Win + R</kbd>), users can bypass menus and launch programs directly.`,
        nestedAccordionId: "nestedAccordion-page-8-win-run-commands"
      }
    ]
  },
  {
    ...
    pages: [
      {
        id: "page-1-note001",
        image: "./assets/images/computerNetworks.png",
      ...
      {
        id: "page-2-note002",
        image: "./assets/images/networkHardware.png",
      ...
      {
        id: "page-3-note003",
        image: "./assets/images/network-structure.png",
        text: "Network Topologies & Technologies",
        modalTitle: "Network Topologies & Technologies",
        modalText: "",
        description: "Modern networks have streamlined around efficient designs , moving away from outdated or costly layouts. Topologies define the network’s physical/logical arrangement , while technologies guide data transmission.",
        nestedAccordionId: "nestedAccordion-page-3-note003"
      },
      {
        id: "page-4-note004",
        ...
        nestedAccordionId: "nestedAccordion-page-4-note004"
      },
      {
        id: "page-5-note005",
        ...
        modalText: "",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero vitae veniam fugit eveniet, hic cum, cumque necessitatibus recusandae, consequatur sapiente dolor? Laboriosam alias laborum necessitatibus veniam placeat, magni accusantium sint?",
        nestedAccordionId: "nestedAccordion-page-5-note005"
      },
      {
        id: "page-6-note006",
        ...
        modalText: "",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero vitae veniam fugit eveniet, hic cum, cumque necessitatibus recusandae, consequatur sapiente dolor? Laboriosam alias laborum necessitatibus veniam placeat, magni accusantium sint?",
        nestedAccordionId: "nestedAccordion-page-6-note006"
      },
      {
        id: "page-7-note007",
        image: "./assets/images/network-analysis.png",
        text: "Network Reference Models and Standards",
        modalTitle: "Network Reference Models and Standards",
        modalText: "",
        description: "Networking can feel complex, but the OSI model and IEEE 802 standards break it down into easy steps. The OSI model divides tasks into seven layers—like floors in a building—while IEEE 802 sets hardware rules so different devices can work together. This chapter shows how these frameworks bring clarity and order to network communication.",
        nestedAccordionId: "nestedAccordion-page-7-note007"
      },
      {
        id: "page-8-motherboard",
        image: "./assets/images/motherboard.png",
        text: "Motherboard Components",
        modalTitle: `<i class="fa-solid fa-microchip"></i> Motherboard Components`,
        video: "",
        modalText: "",
        description: `The motherboard, often called the "heart" or "backbone" of a computer, is a crucial component that connects all hardware parts and allows them to communicate. It houses the CPU, RAM, storage, and expansion slots, ensuring the smooth operation of a system.`,
        nestedAccordionId: "nestedAccordion-page-8-motherboard"
      }
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  tooltipElements.forEach((el) => {
    new bootstrap.Tooltip(el); // No custom classes or overrides
  });
});
